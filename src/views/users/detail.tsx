...
export const UserDetailView = () => {
    ...
    const tasks     = useMemo(() => allTasks.filter((t) => t.assigneeId === userId && inSprint(t.sprintId)), [allTasks, userId, sprintFilter]);
    ...
    const handoffs  = useMemo(() => allHandoffs.filter((h) => {
        ...
        return task?.assigneeId === userId && inSprint(h.sprintId);
