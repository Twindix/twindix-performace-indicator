...
const translations: Record<string, Record<"en" | "ar", string>> = {
    ...
    // UI labels
    "On-Time Delivery": { en: "On-Time Delivery", ar: "التسليم في الوقت المحدد" },
    "project name": { en: "project name", ar: "اسم المشروع" },
    "pick a date": { en: "pick a date", ar: "اختر تاريخاً" },
    "End": { en: "End", ar: "النهاية" },
    "Open Blockers": { en: "Open Blockers", ar: "العوائق المفتوحة" },
    "On-time Rate": { en: "On-time Rate", ar: "معدل الالتزام بالمواعيد" },
    "Velocity Over Sprints": { en: "Velocity Over Sprints", ar: "السرعة عبر السبرنتات" },
    "Task Status": { en: "Task Status", ar: "حالة المهمة" },
    "Burn Chart": { en: "Burn Chart", ar: "مخطط الاستهلاك" },
    "Planned vs actual remaining": { en: "Planned vs actual remaining", ar: "المخطط مقابل المتبقي الفعلي" },
    "Actual": { en: "Actual", ar: "الفعلي" },
    "Mention Users": { en: "Mention Users", ar: "إشعار المستخدمين" },
    "sends to all": { en: "sends to all", ar: "يرسل للجميع" },
    "New decisions are submitted as Pending and require PM approval.": { en: "New decisions are submitted as Pending and require PM approval.", ar: "تُقدَّم القرارات الجديدة كمعلّقة وتستلزم موافقة مدير المشروع." },
    "Members": { en: "Members", ar: "الأعضاء" },
    "No delivery analytics available for this sprint.": { en: "No delivery analytics available for this sprint.", ar: "لا توجد تحليلات تسليم لهذا السبرنت." },
    "No time tracking data for this sprint.": { en: "No time tracking data for this sprint.", ar: "لا توجد بيانات تتبع الوقت لهذا السبرنت." },
    "Log Time": { en: "Log Time", ar: "تسجيل الوقت" },
    "Download CSV": { en: "Download CSV", ar: "تنزيل CSV" },
    "Phase transition criteria and handoff readiness": { en: "Phase transition criteria and handoff readiness", ar: "معايير انتقال المرحلة وجاهزية التسليم" },
    "No criteria found for this project/sprint.": { en: "No criteria found for this project/sprint.", ar: "لا توجد معايير لهذا المشروع/السبرنت." },
    "No Handoff Data": { en: "No Handoff Data", ar: "لا توجد بيانات تسليم" },
    "Features and their authors across the platform": { en: "Features and their authors across the platform", ar: "الميزات ومؤلفوها عبر المنصة" },
    "Multi-section project report with export per section": { en: "Multi-section project report with export per section", ar: "تقرير مشروع متعدد الأقسام مع تصدير لكل قسم" },
    "Needs attention": { en: "Needs attention", ar: "يحتاج انتباهاً" },
    "New Deploy": { en: "New Deploy", ar: "نشر جديد" },
    "Download": { en: "Download", ar: "تنزيل" },
    "Manage sprints and activate the current one.": { en: "Manage sprints and activate the current one.", ar: "إدارة السبرنتات وتفعيل الحالي." },

    // Toast — success messages
    "Alert created successfully.": { en: "Alert created successfully.", ar: "تم إنشاء التنبيه بنجاح." },
    "Alert updated successfully.": { en: "Alert updated successfully.", ar: "تم تحديث التنبيه بنجاح." },
    "Alert deleted successfully.": { en: "Alert deleted successfully.", ar: "تم حذف التنبيه بنجاح." },
    "Alert acknowledged.": { en: "Alert acknowledged.", ar: "تم الإقرار بالتنبيه." },
    "Alert marked as done.": { en: "Alert marked as done.", ar: "تم وضع التنبيه كمنجز." },
    "Blocker created successfully.": { en: "Blocker created successfully.", ar: "تم إنشاء العائق بنجاح." },
    "Blocker updated successfully.": { en: "Blocker updated successfully.", ar: "تم تحديث العائق بنجاح." },
    "Blocker deleted successfully.": { en: "Blocker deleted successfully.", ar: "تم حذف العائق بنجاح." },
    "Blocker marked as resolved.": { en: "Blocker marked as resolved.", ar: "تم وضع العائق كمحلول." },
    "Blocker escalated.": { en: "Blocker escalated.", ar: "تم تصعيد العائق." },
    "Tasks linked successfully.": { en: "Tasks linked successfully.", ar: "تم ربط المهام بنجاح." },
    "Task unlinked.": { en: "Task unlinked.", ar: "تم إلغاء ربط المهمة." },
    "Comment posted.": { en: "Comment posted.", ar: "تم نشر التعليق." },
    "Comment updated.": { en: "Comment updated.", ar: "تم تحديث التعليق." },
    "Comment deleted.": { en: "Comment deleted.", ar: "تم حذف التعليق." },
    "Response sent.": { en: "Response sent.", ar: "تم إرسال الرد." },
    "Decision created successfully.": { en: "Decision created successfully.", ar: "تم إنشاء القرار بنجاح." },
    "Decision updated successfully.": { en: "Decision updated successfully.", ar: "تم تحديث القرار بنجاح." },
    "Decision deleted successfully.": { en: "Decision deleted successfully.", ar: "تم حذف القرار بنجاح." },
    "Deploy uploaded successfully.": { en: "Deploy uploaded successfully.", ar: "تم رفع النشر بنجاح." },
    "Deploy status updated.": { en: "Deploy status updated.", ar: "تم تحديث حالة النشر." },
    "Deploy deleted.": { en: "Deploy deleted.", ar: "تم حذف النشر." },
    "Criteria added.": { en: "Criteria added.", ar: "تمت إضافة المعيار." },
    "Criteria updated.": { en: "Criteria updated.", ar: "تم تحديث المعيار." },
    "Criteria deleted.": { en: "Criteria deleted.", ar: "تم حذف المعيار." },
    "Meeting created.": { en: "Meeting created.", ar: "تم إنشاء الاجتماع." },
    "Meeting updated.": { en: "Meeting updated.", ar: "تم تحديث الاجتماع." },
    "Meeting deleted.": { en: "Meeting deleted.", ar: "تم حذف الاجتماع." },
    "Meeting finalized.": { en: "Meeting finalized.", ar: "تم إنهاء الاجتماع." },
    "RSVP updated.": { en: "RSVP updated.", ar: "تم تحديث الرد على الدعوة." },
    "Comment added.": { en: "Comment added.", ar: "تمت إضافة التعليق." },
    "Attachment uploaded.": { en: "Attachment uploaded.", ar: "تم رفع المرفق." },
    "Feature created.": { en: "Feature created.", ar: "تم إنشاء الميزة." },
    "Feature updated.": { en: "Feature updated.", ar: "تم تحديث الميزة." },
    "Feature deleted.": { en: "Feature deleted.", ar: "تم حذف الميزة." },
    "Project created.": { en: "Project created.", ar: "تم إنشاء المشروع." },
    "Project updated.": { en: "Project updated.", ar: "تم تحديث المشروع." },
    "Project deleted.": { en: "Project deleted.", ar: "تم حذف المشروع." },
    "Red flag created successfully.": { en: "Red flag created successfully.", ar: "تم رفع العلم الأحمر بنجاح." },
    "Red flag updated successfully.": { en: "Red flag updated successfully.", ar: "تم تحديث العلم الأحمر بنجاح." },
    "Red flag deleted successfully.": { en: "Red flag deleted successfully.", ar: "تم حذف العلم الأحمر بنجاح." },
    "Reminder created.": { en: "Reminder created.", ar: "تم إنشاء التذكير." },
    "Reminder updated.": { en: "Reminder updated.", ar: "تم تحديث التذكير." },
    "Reminder deleted.": { en: "Reminder deleted.", ar: "تم حذف التذكير." },
    "Reminder dismissed.": { en: "Reminder dismissed.", ar: "تم رفض التذكير." },
    "Reminder reactivated.": { en: "Reminder reactivated.", ar: "تم إعادة تفعيل التذكير." },
    "Requirement added.": { en: "Requirement added.", ar: "تمت إضافة المتطلب." },
    "Requirement updated.": { en: "Requirement updated.", ar: "تم تحديث المتطلب." },
    "Requirement toggled.": { en: "Requirement toggled.", ar: "تم تبديل حالة المتطلب." },
    "Requirement deleted.": { en: "Requirement deleted.", ar: "تم حذف المتطلب." },
    "Sprint created successfully.": { en: "Sprint created successfully.", ar: "تم إنشاء السبرنت بنجاح." },
    "Sprint updated successfully.": { en: "Sprint updated successfully.", ar: "تم تحديث السبرنت بنجاح." },
    "Sprint deleted successfully.": { en: "Sprint deleted successfully.", ar: "تم حذف السبرنت بنجاح." },
    "Sprint activated successfully.": { en: "Sprint activated successfully.", ar: "تم تفعيل السبرنت بنجاح." },
    "Task created.": { en: "Task created.", ar: "تم إنشاء المهمة." },
    "Task updated.": { en: "Task updated.", ar: "تم تحديث المهمة." },
    "Task deleted.": { en: "Task deleted.", ar: "تم حذف المهمة." },
    "Attachment deleted.": { en: "Attachment deleted.", ar: "تم حذف المرفق." },
    "Tag added.": { en: "Tag added.", ar: "تمت إضافة الوسم." },
    "Tag removed.": { en: "Tag removed.", ar: "تم إزالة الوسم." },
    "Sent for manager approval.": { en: "Sent for manager approval.", ar: "أُرسل للموافقة من المدير." },
    "Team created successfully.": { en: "Team created successfully.", ar: "تم إنشاء الفريق بنجاح." },
    "Team updated.": { en: "Team updated.", ar: "تم تحديث الفريق." },
    "Team deleted.": { en: "Team deleted.", ar: "تم حذف الفريق." },
    "Time logged successfully.": { en: "Time logged successfully.", ar: "تم تسجيل الوقت بنجاح." },
    "Time log added.": { en: "Time log added.", ar: "تمت إضافة سجل الوقت." },
    "Time log updated.": { en: "Time log updated.", ar: "تم تحديث سجل الوقت." },
    "Time log deleted.": { en: "Time log deleted.", ar: "تم حذف سجل الوقت." },
    ...
    "You don't have permission to do this.": { en: "You don't have permission to do this.", ar: "ليس لديك صلاحية للقيام بذلك." },
    "Network issue — please try again.": { en: "Network issue — please try again.", ar: "مشكلة في الشبكة — يرجى المحاولة مجدداً." },
    "You're going too fast — try again in a moment.": { en: "You're going too fast — try again in a moment.", ar: "أنت تتصرف بسرعة — حاول مجدداً بعد لحظة." },
    "Something went wrong. Please try again.": { en: "Something went wrong. Please try again.", ar: "حدث خطأ ما. يرجى المحاولة مجدداً." },
    "Something went wrong.": { en: "Something went wrong.", ar: "حدث خطأ ما." },
    "Please select a sprint from the top bar first.": { en: "Please select a sprint from the top bar first.", ar: "يرجى اختيار سبرنت من الشريط العلوي أولاً." },
};
