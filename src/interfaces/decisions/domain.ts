...
export interface DecisionFormStateInterface {
    title: string;
    description: string;
    category: DecisionCategory;
}

export type DecisionFormErrorsInterface = Partial<Record<keyof DecisionFormStateInterface, string>>;

export interface DecisionsPageFiltersInterface {
