export const translations: Record<string, Record<"en" | "ar", string>> = {
    // Brand
    ...
    "Group your sprints into projects.": { en: "Group your sprints into projects.", ar: "قم بتجميع سبرنتاتك في مشاريع." },
    ...
    "sprints": { en: "sprints", ar: "سبرنتات" },

    // Sprints
    "Sprints": { en: "Sprints", ar: "السبرنتات" },
    "Manage sprints and activate the current one.": { en: "Manage sprints and activate the current one.", ar: "إدارة السبرنتات وتفعيل السبرنت الحالي." },
    "No sprints yet": { en: "No sprints yet", ar: "لا توجد سبرنتات بعد" },
    "Create your first sprint to start planning work.": { en: "Create your first sprint to start planning work.", ar: "أنشئ سبرنتك الأول لبدء تخطيط العمل." },
    "Activate": { en: "Activate", ar: "تفعيل" },
    "Edit Sprint": { en: "Edit Sprint", ar: "تعديل السبرنت" },
    "Sprint 12": { en: "Sprint 12", ar: "السبرنت 12" },
    "Delete Sprint": { en: "Delete Sprint", ar: "حذف السبرنت" },
    ...
    "Red Flags": { en: "Red Flags", ar: "العلامات الحمراء" },
    ...
    "Task Rejection": { en: "Task Rejection", ar: "رفض المهام" },
    "Urgent Alerts": { en: "Urgent Alerts", ar: "التنبيهات العاجلة" },
    "Stalled Red Flags": { en: "Stalled Red Flags", ar: "العلامات الحمراء المتوقفة" },
    "Total Red Flags": { en: "Total Red Flags", ar: "إجمالي العلامات الحمراء" },
    "Total Comments": { en: "Total Comments", ar: "إجمالي التعليقات" },
    "Responded Comments": { en: "Responded Comments", ar: "التعليقات المُجابة" },
    "Alert Response": { en: "Alert Response", ar: "استجابة التنبيه" },
    "Red Flag Response": { en: "Red Flag Response", ar: "استجابة العلم الأحمر" },
    "Time Delivery": { en: "Time Delivery", ar: "توقيت التسليم" },
    "Comments Response": { en: "Comments Response", ar: "استجابة التعليقات" },
    "Not Approval (%)": { en: "Not Approval (%)", ar: "نسبة عدم الموافقة" },
};
