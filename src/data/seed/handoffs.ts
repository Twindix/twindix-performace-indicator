...
// Sprint ids reference timeSeed sprints (sp-01..sp-06) which group into
// projects (pr-01..pr-05) via timeSeed.sprints[*].project_id.
export const handoffsSeed: HandoffInterface[] = [
    {
        id: "hnd-001",
        fromPhase: "Design",
        toPhase: "Development",
    ...
    },
    {
        ...
        completionRate: 70,
        entryCriteria: [
            { id: "ec-025", label: "Model spec reviewed", met: true },
            { id: "ec-026", label: "Dataset sample shared", met: true },
            { id: "ec-027", label: "Evaluation harness proposed", met: false },
        ],
        exitCriteria: [
            { id: "xc-016", label: "Training pipeline wired", met: true },
            { id: "xc-017", label: "Evaluation runs reproducible", met: false },
        ],
    },
    {
        id: "hnd-008",
        ...
        entryCriteria: [
            { id: "ec-028", label: "Campaign copy finalized", met: true },
            { id: "ec-029", label: "Assets approved by brand", met: true },
        ],
        exitCriteria: [
            { id: "xc-018", label: "Launch checklist signed-off", met: true },
        ],
    },
];
